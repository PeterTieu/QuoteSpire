...
//Class called by the GetSearchQuotesByAuthorAsyncTask AsyncTask inner class of the SearchQuotesByAuthorFragment class.
...
public class GetSearchQuotesByAuthorQuote {
    ...
    public Quote getSearchQuotesByAuthorQuote(String searchQuery){

        Quote quote = new Quote(); //Create Quote object

        String URLString = "http://quotes.rest/quote/search.json?minlength=0&maxlength=1000&author=" + searchQuery + "&private=false&api_key=" + APIKey.API_KEY; //Get URL string containing the search query
        ...
        Log.i(TAG, "Search Quotes by Author Quote - Quote: " + quote.getQuote());
        Log.i(TAG, "Search Quotes by Author Quote - Author: " + quote.getAuthor());
    ...
    "contents": {
        ...
        //Run through each of the String under the "author" title of the JSON Object and save it to the categoriesArrayList
        for (int i=0; i<categoriesJSONArray.length(); i++){
            String author = categoriesJSONArray.getString(i);
            categoriesArrayList.add(author);
        }
        ...
        //Log to Logcat
        Log.i(TAG, "Search Quotes by Author Quote - method - Quote String: " + quote.getQuote());
        Log.i(TAG, "Search Quotes by Author Quote - method  - Author: " + quote.getAuthor());
        Log.i(TAG, "Search Quotes by Author Quote - method - ID: " + quote.getId());
