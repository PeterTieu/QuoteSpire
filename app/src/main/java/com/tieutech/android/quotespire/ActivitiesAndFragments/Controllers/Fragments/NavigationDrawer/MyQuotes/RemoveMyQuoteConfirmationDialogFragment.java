...
public class RemoveMyQuoteConfirmationDialogFragment extends DialogFragment {
    ...
    public static RemoveMyQuoteConfirmationDialogFragment newInstance(String myQuoteAuthor, String myQuoteQuote, int position){
        ...
        RemoveMyQuoteConfirmationDialogFragment removeMyQuoteConfirmationDialogFragment = new RemoveMyQuoteConfirmationDialogFragment();

        removeMyQuoteConfirmationDialogFragment.setArguments(argumentBundle);

        return removeMyQuoteConfirmationDialogFragment;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.dialog_fragment_remove_my_quote_confirmation, null);
