...
//Class called by the GetSearchQuotesByKeywordAsyncTask AsyncTask inner class of the SearchQuotesByKeywordFragment class.
//Objective: Searches the Quote based on the keyword or phrase search query passed to the SearchView of SearchQuotesByKeywordFragment.
public class GetSearchQuotesByKeywordQuote {
    ...
    //Get the Quote (based on the search query passed to the SearchView of SearchQuotesByKeywordFragment)
    public Quote getSearchQuotesByKeywordQuote(String searchQuery){
        ...
        Log.i(TAG, "Search Quotes by Keyword Quote - Quote: " + quote.getQuote());
        Log.i(TAG, "Search Quotes by Keyword Quote - Author: " + quote.getAuthor());
    ...
    "contents": {
        ...
        "author": "Sivananda",
        "id": "GVPBN3r3RfEP_1rBa4b5jQeF",
        "permalink": "https://theysaidso.com/quote/sivananda-meditation-is-the-dissolution-of-thoughts-in-eternal-awareness-or-pure",
