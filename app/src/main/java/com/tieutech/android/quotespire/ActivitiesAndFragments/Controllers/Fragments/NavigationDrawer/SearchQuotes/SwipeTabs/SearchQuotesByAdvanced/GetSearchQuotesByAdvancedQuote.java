package com.tieutech.android.quotespire.ActivitiesAndFragments.Controllers.Fragments.NavigationDrawer.SearchQuotes.SwipeTabs.SearchQuotesByAdvanced;
...
//Class called by the GetSearchQuotesByAdvancedAsyncTask AsyncTask inner class of the SearchQuotesByAdvancedFragment class.
//Objective: Searches the Quote based on the advanced or phrase search query passed to the SearchView of SearchQuotesByAdvancedFragment.
public class GetSearchQuotesByAdvancedQuote {

    private static final String TAG = "GetAdvancedQuote"; //Tag for Logcat
    ...
    //Get the Quote (based on the search query passed to the SearchView of SearchQuotesByAdvancedFragment)
    public Quote getSearchQuotesByAdvancedQuote(String keywordSearchQuery, String authorSearchQuery, String categorySearchQuery){
        ...
        try {
            String JSONString = getJSONString(mURLString); //Get JSON String from the URL String
        ...
        Log.i(TAG, "Search Quotes by Advanced Quote - Quote: " + quote.getQuote());
        Log.i(TAG, "Search Quotes by Advanced Quote - Author: " + quote.getAuthor());
    ...
    "contents": {
        ...
        //Run through each of the String under the "advanced" title of the JSON Object and save it to the categoriesArrayList
        for (int i=0; i<categoriesJSONArray.length(); i++){
            String advanced = categoriesJSONArray.getString(i);
            categoriesArrayList.add(advanced);
        }
        ...
        //Log to Logcat
        Log.i(TAG, "Search Quotes by Advanced Quote - method - Quote String: " + quote.getQuote());
        Log.i(TAG, "Search Quotes by Advanced Quote - method  - Author: " + quote.getAuthor());
        Log.i(TAG, "Search Quotes by Advanced Quote - method - ID: " + quote.getId());
